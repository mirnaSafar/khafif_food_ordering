...
//     bool isAmericanExpress = _americanExpressRegExp.hasMatch(cleanNumber);
...
//     final messages = locale == 'ar' ? ArMessages() : EnMessages();
//     // Remove the white spaces inserted by formatters
//     final cleanNumber = number.replaceAll(' ', '');
//     if (cleanNumber.isEmpty) {
//       return messages.reqired();
//     }
//     switch (this) {
//       case BrandType.visa:
...
//           return null;
//         } else {
//           return messages.inavlidMadaNumber();
//         }
//       default:
//         return messages.noBrandProvided();
//     }
//   }
