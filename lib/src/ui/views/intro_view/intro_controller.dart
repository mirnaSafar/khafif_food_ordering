...
class IntroController extends BaseController {
  ...
  void startAutoTransition() {
    // Add a periodic timer to trigger automatic transition
    const duration = Duration(seconds: 3); // Example: 3 seconds interval
    Timer.periodic(duration, (Timer t) {
      ...
      animationController.forward(
          from: 0); // Start the animation from the beginning
    });
  }
