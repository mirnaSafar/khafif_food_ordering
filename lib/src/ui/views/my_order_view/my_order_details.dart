...
//   const MyOrder({super.key, this.showMyOrderCart});
//   final bool? showMyOrderCart;
//   @override
//   State<MyOrder> createState() => _ConfirmOrderViewState();
// }

// class _ConfirmOrderViewState extends State<MyOrder> {
...
//                               : CustomText(
//                                   text:
//                                       '${controller.customerCart!.value.amountTotal} SAR',
...
//                               btnCart(
//                                 onPressed: () {
//                                   controller.selectedCart.value.productUomQty! >
//                                           1
...
//                                             .isNotEmpty
//                                         ? controller.updateOrder(incress: true)
//                                         : null;
//                                   },
//                                   plusBtn: true,
...
//                                     (cart) {
//                                       // var index = controller.customerCart!.value.line!.indexOf(cart);
//                                       return InkWell(
//                                         onTap: () {
//                                           controller.setOderCount =
//                                               cart.productUomQty!.toInt();
//                                           controller.selectedCart.value = cart;
//                                         },
//                                         child: Padding(
