...
class _ProductDetailsViewState extends State<ProductDetailsView> {
  ...
  void initState() {
    productDetailsController =
        Get.put(ProductDetailsController(product: widget.product));
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              if (productDetailsController
                                      ...
                                      null &&
                                  productDetailsController
                                      .product!.variantValue!.isNotEmpty) ...[
                                CustomListView(
                                    itemCount: productDetailsController
                                            .product!.variantValue?.length ??
                                        0,
                        ...
                        child: Obx(() {
                          ...
                          return CustomButton(
                            ...
                            onPressed: productDetailsController
                                ...
                                ? () {
                                    // productDetailsController
                                    //         .selectedVariantsItems.isNotEmpty
                                    //     ? productDetailsController.setCartName()
                                    //     : null;
                                ...
                                : () => showSnackbarText(
                                    'You should select a topping first',
                                    internetSnack: false,
                                    imageName: 'info'),
                            text: 'Add to Cart',
                          );
